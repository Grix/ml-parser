...
var ind = ML_InitParserEmpty(argument0);
    ...
    ML_AddUnaryOper(ind, "-",16,_ML_FNegate, ML_VAL_REAL, ML_VAL_REAL);
    ML_AddUnaryOper(ind, "+",16,_ML_FPositive, ML_VAL_REAL, ML_VAL_REAL);
    ML_AddUnaryOper(ind, "~",16,_ML_FBitnegate, ML_VAL_REAL, ML_VAL_REAL);
