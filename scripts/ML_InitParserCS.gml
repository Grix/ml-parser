...
var ind = ML_InitParserEmpty(argument0);
    ...
    ML_AddBinaryOper(ind,"+",13,_ML_FAdd, ML_VAL_STRING, ML_VAL_STRING, ML_VAL_STRING);
    ...
    ML_AddBinaryOper(ind,"%",14,_ML_FModulo, ML_VAL_REAL, ML_VAL_REAL, ML_VAL_REAL);
    ...
    ML_AddBinaryOper(ind,"<",11,_ML_FLess, ML_VAL_REAL, ML_VAL_STRING, ML_VAL_STRING);
    ML_AddBinaryOper(ind,"<=",11,_ML_FLessequal, ML_VAL_REAL, ML_VAL_STRING, ML_VAL_STRING);
    ML_AddBinaryOper(ind,">",11,_ML_FGreater, ML_VAL_REAL, ML_VAL_STRING, ML_VAL_STRING);
    ML_AddBinaryOper(ind,">=",11,_ML_FGreaterequal, ML_VAL_REAL, ML_VAL_STRING, ML_VAL_STRING);
    ...
    ML_AddBinaryOper(ind,"==",10,_ML_FIs, ML_VAL_REAL, ML_VAL_STRING, ML_VAL_STRING);
    ML_AddBinaryOper(ind,"!=",10,_ML_FIsnot, ML_VAL_REAL, ML_VAL_STRING, ML_VAL_STRING);
    
    ML_AddBinaryOper(ind,"&",9,_ML_FBitand, ML_VAL_REAL, ML_VAL_REAL, ML_VAL_REAL);
    
    ML_AddBinaryOper(ind,"^",8,_ML_FBitxor, ML_VAL_REAL, ML_VAL_REAL, ML_VAL_REAL);
    ...
    ML_AddUnaryOper(ind,"!",15,_ML_FNot, ML_VAL_REAL, ML_VAL_REAL);
    ML_AddUnaryOper(ind,"-",15,_ML_FNegate, ML_VAL_REAL, ML_VAL_REAL);
    ML_AddUnaryOper(ind,"+",15,_ML_FPositive, ML_VAL_REAL, ML_VAL_REAL);
    ML_AddUnaryOper(ind,"~",15,_ML_FBitnegate, ML_VAL_REAL, ML_VAL_REAL);
    
    ML_AddAssignOper(ind,"=",2,_ML_FAssign, ML_VAL_REAL, ML_VAL_REAL, ML_VAL_REAL);
    ML_AddAssignOper(ind,"=",2,_ML_FAssign, ML_VAL_STRING, ML_VAL_STRING, ML_VAL_STRING);
    ML_AddAssignOper(ind,"+=",2,_ML_FSumassign, ML_VAL_REAL, ML_VAL_REAL, ML_VAL_REAL);
    ML_AddAssignOper(ind,"+=",2,_ML_FSumassign, ML_VAL_STRING, ML_VAL_STRING, ML_VAL_STRING);
    ...
    ML_AddAssignOper(ind,"%=",2,_ML_FModassign, ML_VAL_REAL, ML_VAL_REAL, ML_VAL_REAL);
    ...
    ML_AddBinaryOper(ind,",",1,_ML_FComma, ML_VAL_REAL, ML_VAL_STRING, ML_VAL_REAL);
    ML_AddBinaryOper(ind,",",1,_ML_FComma, ML_VAL_STRING, ML_VAL_REAL, ML_VAL_STRING);
    ML_AddBinaryOper(ind,",",1,_ML_FComma, ML_VAL_STRING, ML_VAL_STRING, ML_VAL_STRING);

    ML_AddFunction(ind, "string",_ML_FMakeString,ML_VAL_STRING,ML_VAL_REAL);
    ML_AddFunction(ind, "real",_ML_FMakeReal,ML_VAL_REAL,ML_VAL_STRING);
